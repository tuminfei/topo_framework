#[test_only]
module aptos_framework::topo_coin_tests {
    ...
    fun test_topo_setup_and_mint(aptos_framework: &signer) {
    ...
    fun test_fa_helpers_for_test() {
        ...
        assert!(object::object_exists<Metadata>(@aptos_fungible_asset), 0);
        mint_topo_fa_to_primary_fungible_store_for_test(@aptos_framework, 100);
